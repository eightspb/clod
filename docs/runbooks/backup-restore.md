...
это измеренный RTO. Первое измерение 4 сентября 2026 года: см. раздел «Журнал учений» ниже.
...
|---|---|---|---|---|---|---|
| 2026-09-04 | первый прогон после внедрения | заполняется после запуска | | | | |
