      ...
      <section className="section">
        <div className="container-clay">
          ...
          <div className="relative">
            <div className="hidden md:block absolute left-6 top-8 bottom-8 w-0.5 bg-clay-mint/20" />
            <div className="space-y-5">
              {VAB_TIMELINE.map((step, index) => (
                <div key={step.day} className="flex gap-5 items-start">
                  <div className="flex flex-col items-center shrink-0 pt-1">
                    <div className={`w-3 h-3 rounded-full ${step.dotColor} z-10`} />
                    {index < VAB_TIMELINE.length - 1 && (
                      <div className="flex-1 w-0.5 bg-clay-mint/20 mt-1 md:hidden" style={{ minHeight: '2rem' }} />
                    )}
                  </div>
                  <div className={`clay-card p-5 flex-1`}>
                    <div className="flex flex-wrap items-center gap-3 mb-2">
                      <span className="stat-pill">{step.day}</span>
      ...
      <section className="section">
        <div className="container-clay">
          ...
          <div className="clay-card p-6 md:p-8">
            ...
            <div className="clay-card-soft-peach p-4 rounded-2xl">
