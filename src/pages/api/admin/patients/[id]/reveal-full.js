...
import { createPatientRevealFullEndpoint } from '../../../../../lib/admin-patient-api.js'
...
function log(stage) {
  console.error('[admin/patients/[id]/reveal-full]', stage)
}

export { createPatientRevealFullEndpoint }
export const POST = createPatientRevealFullEndpoint({ records, history, log })
