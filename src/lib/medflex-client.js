...
const HISTORY_KEYS = Object.freeze(['dateEnd', 'dateStart', 'lpuId', 'mobilePhone', 'page', 'size', 'uuid'])
...
function historyQuery(input) {
  ...
  if (options.mobilePhone !== undefined && (typeof options.mobilePhone !== 'string' || !/^7\d{10,12}$/.test(options.mobilePhone))) throw new TypeError('Medflex history phone must use the API format')
  appendOptional(query, 'mobile_phone', options.mobilePhone)
