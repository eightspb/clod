export const CLINIC_FACTS = [
  ...
  },
  {
    ...
    desc: 'Запись день в день. Ответ администратора в Telegram за 2 минуты',
  },
  {
    iconName: 'MapPin',
...
export const SERVICES = [
  {
    ...
    title: 'Маммология',
    desc: 'Диагностика и лечение заболеваний молочной железы. Онкологи-маммологи с опытом 15+ лет.',
    stat: '15+',
    statLabel: 'лет опыта',
    to: '/mammology',
  },
  {
    ...
    tag: 'Топ-манипуляция',
    title: 'ВАБ',
    desc: 'Вакуумная аспирационная биопсия — топ-манипуляция клиники. Удаление новообразований груди за 30 минут через прокол 2 мм. Без скальпеля, без наркоза, без швов.',
    stat: '30 мин',
    statLabel: 'процедура',
    to: '/vab',
  },
  ...
  },
  {
    ...
    title: 'Нутрициология',
    desc: 'Персональный план питания и коррекция нутритивного статуса. Здоровье через правильное питание и образ жизни.',
    stat: '1–3',
    statLabel: 'визита',
    to: '/nutrition',
  },
...
export const WHY_ITEMS = [
  ...
  { iconName: 'Clock',   bg: 'icon-circle-blue',     title: 'Сервис без ожидания',    desc: 'Запись день в день. Ответ администратора в Telegram за 2 минуты.' },
