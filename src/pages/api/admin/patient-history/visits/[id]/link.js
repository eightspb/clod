...
import { createPatientHistoryVisitLinkEndpoint } from '../../../../../../lib/admin-patient-history-api.js'
...
function log(stage) {
  console.error('[admin/patient-history/visits/[id]/link]', stage)
}

export { createPatientHistoryVisitLinkEndpoint }
export const POST = createPatientHistoryVisitLinkEndpoint({ history, log })
