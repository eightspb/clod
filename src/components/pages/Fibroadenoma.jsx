...
export function Fibroadenoma() {
  return (
    <div>
      ...
      <section className="section">
        <div className="container-clay">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Что такое фиброаденома</h2>
      ...
      <section className="section">
        <div className="container-clay">
          <div className="text-center mb-7">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Диагностика фиброаденомы</h2>
      ...
      <section className="section">
        <div className="container-clay">
          <div className="text-center mb-7">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Варианты лечения</h2>
