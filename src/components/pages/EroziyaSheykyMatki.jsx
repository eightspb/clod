...
export function EroziyaSheykyMatki() {
  return (
    <div>
      <section className="relative overflow-hidden pt-8 pb-12">
        <div className="container-clay relative z-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold mb-5 text-white" style={{ background: 'linear-gradient(145deg, #E8886A, #C96B4E)' }}>
              <Zap size={12} />
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-clay-dark leading-tight mb-5">
              Эрозия шейки матки:{' '}
              <span className="text-clay-peach">диагностика и лечение в СПб</span>
            </h1>
            ...
            {[
              ...
              <div key={s.label} className="clay clay-card p-4 text-center">
                <div className="flex items-end justify-center gap-0.5">
                  <span className="text-3xl sm:text-4xl font-extrabold text-clay-peach leading-none">{s.val}</span>
      ...
      <section className="section">
        <div className="container-clay">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Что такое эрозия шейки матки</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {symptoms.map((s, i) => (
              <div key={i} className="clay clay-card flex items-center gap-3 px-4 py-3">
                {s.icon}
      ...
      <section className="section">
        <div className="container-clay">
          <div className="text-center mb-7">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Диагностика эрозии шейки матки</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {diagnostics.map((d) => (
              <div key={d.title} className={`clay ${d.card} p-6`}>
      ...
      <section className="section">
        <div className="container-clay">
          <div className="text-center mb-7">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Лечение эрозии шейки матки</h2>
            <p className="text-clay-muted max-w-lg mx-auto">Тактика зависит от цитологии, кольпоскопической картины и данных ВПЧ-теста</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {treatments.map((t) => (
              <div key={t.title} className={`clay ${t.card} p-6`}>
                <div className="flex items-start gap-4 mb-3">
      ...
      <section className="section">
        <div className="container-clay">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            <div>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-4">Маршрут пациентки</h2>
              <p className="text-clay-muted mb-6 leading-relaxed">Пошагово — от осмотра до обоснованного решения</p>
              <div className="space-y-4">
                {steps.map((s) => (
                  <div key={s.n} className="clay clay-card flex items-start gap-3 px-4 py-4">
      ...
      <section className="section">
        <div className="container-clay">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Наши гинекологи</h2>
      ...
      <section className="section">
        <div className="container-clay">
          <h2 className="text-xl font-extrabold text-clay-dark mb-5">Полезные материалы</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {relatedArticles.map((a) => (
              <a key={a.href} href={a.href} className="clay clay-card-soft-peach p-5 flex items-start gap-3 group hover:shadow-lg transition-shadow">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
            <a href="/gynecology" className="clay clay-card p-5 flex items-start gap-3 group hover:shadow-lg transition-shadow">
