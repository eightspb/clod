...
export const GYNECOLOGY_FAQ = [
  {
    ...
    answer: 'На первичном приёме гинеколог проводит осмотр, УЗИ малого таза, при необходимости берёт мазки и назначает анализы. Всё необходимое для старта диагностики можно обсудить и организовать за один визит.',
  },
  {
...
const features = [
  {
    ...
    subtitle: 'Бережный осмотр без спешки',
    desc: 'Используем инструменты минимального размера и подогретые гели. Тёплая атмосфера, без спешки и без осуждений, чтобы приём проходил спокойно и деликатно.',
  ...
  },
  {
    ...
    subtitle: 'Лечение только по показаниям',
  ...
  },
  {
    ...
    subtitle: 'Осмотр, УЗИ и нужные анализы',
    desc: 'УЗИ малого таза, кольпоскопия и забор необходимых тестов можно организовать за один визит. По итогам приёма вы получаете понятный план наблюдения и дальнейших шагов.',
      ...
      <section className="section">
        <div className="container-clay">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              { val: '1', label: 'визит для старта диагностики и плана действий' },
              { val: 'УЗИ', label: 'малого таза прямо на приёме при необходимости' },
              { val: 'По показаниям', label: 'назначаем лечение без лишних схем' },
        ...
        <div className="container-clay">
          <div className="clay clay-card-soft-peach p-6 md:p-8 text-center">
            ...
            <p className="text-clay-muted mb-5 max-w-md mx-auto">
              Ответим в Telegram в течение 2 минут. Запись день в день - доступна по будням.
            </p>
