...
const STEPS = [
  ...
  },
  {
    num: '06',
    title: 'Выход домой',
    desc: 'Процедура занимает 30-40 минут. После 1-2 часов наблюдения вы уходите домой. Сроки возвращения к работе и необходимость больничного определяет врач.',
  },
]
...
const COMPARE_ROWS = [
  ...
  { param: 'Гистология', vab: 'Оплачивается отдельно', op: 'Уточняется в смете' },
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: 'Нет. ВАБ - амбулаторная процедура. После 1-2 часов наблюдения вы уходите домой. Сроки возвращения к работе и необходимость больничного определяет врач.',
  },
  {
