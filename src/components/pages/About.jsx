      ...
      <section className="section">
        <div className="container-clay">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
            {[
              { val: '99%', color: 'text-clay-mint', card: 'clay-card-soft-mint', label: 'пациентов избегают операции', desc: 'Благодаря топ-манипуляции ВАБ' },
      ...
      <section className="section">
        <div className="container-clay">
          ...
          <div className="space-y-5 text-clay-muted leading-relaxed max-w-3xl">
            ...
            <p>
              Основное направление клиники — вакуумная аспирационная биопсия (ВАБ), топ-манипуляция в маммологии. Клиника №1 в России по ВАБ согласно отзывам пациентов. 99% пациентов, пришедших с направлением на операцию из другой клиники, решают проблему за 30 минут без скальпеля и швов. Это не просто медицинская процедура — это другой стандарт помощи.
            </p>
          </div>
        </div>
      </section>
