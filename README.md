...
| `MEDFLEX_CLINIC_TOKEN` | Серверный токен клиники для Medflex API |
| `BOOKING_INTENT_SECRET` | Отдельный HMAC-секрет для защищённой дедупликации записи |
