...
const principles = [
  ...
  },
  {
    ...
    bg: 'clay-card-peach',
    title: 'Прямая связь',
    desc: 'После процедур лечащий врач остаётся на связи в мессенджере. Любой вопрос о вашем состоянии — ответ в тот же день, без промежуточных звонков в колл-центр.',
            ...
            <div className="clay-card p-6 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-clay-muted text-sm leading-relaxed">
                  Все ваши медицинские данные хранятся в зашифрованном облаке с сертификацией по 152-ФЗ. Доступ только у вас и вашего врача.
                </p>
              </div>
            </div>
            <div className="clay-card p-6 flex items-start gap-4">
