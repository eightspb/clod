...
1. **ВАБ (Основное направление)** - топ-манипуляция клиники. Визуал: цифровой блок со статистикой 99% и счётчиками клиники.
2. **Второе мнение** - для тех, кому уже назначили операцию. Визуал: BI-RADS классификация, шаги загрузки документов.
3. **Экосистема** - гинекология, эндокринология, нутрициология. Визуал: три направления с тегами результата.
...
- **Статистика**: «1/3 пациентов» → «99% пациентов избегают операции» (с дисклеймером) на всех страницах
- **Hero Block**: убраны правые визуальные карточки; добавлены цифровые блоки со статистикой; слайд 1 — лидерство Одинцова/Опнина и статус №1 по ВАБ; дисклеймер под 99%
