...
export function KistaMolochnoyZhelezy() {
  return (
    <div>
        ...
        <div className="container-clay relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-clay-dark leading-tight mb-5">
              ...
              <span className="text-clay-mint">диагностика и лечение в СПб</span>
            </h1>
      ...
      <section className="section">
        <div className="container-clay">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Что такое киста молочной железы</h2>
      ...
      <section className="section">
        <div className="container-clay">
          <div className="text-center mb-7">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Диагностика кисты</h2>
      ...
      <section className="section">
        <div className="container-clay">
          <div className="text-center mb-7">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Лечение кисты молочной железы</h2>
      ...
      <section className="section">
        <div className="container-clay">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Наши маммологи</h2>
        ...
        <div className="container-clay">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {relatedArticles.map((a) => (
              <a key={a.href} href={a.href} className="clay clay-card-soft-mint p-5 flex items-start gap-3 group hover:shadow-lg transition-shadow">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
            <a href="/mammology" className="clay clay-card p-5 flex items-start gap-3 group hover:shadow-lg transition-shadow">
            ...
            <a href="/vab" className="clay clay-card p-5 flex items-start gap-3 group hover:shadow-lg transition-shadow">
              ...
              <div>
                ...
                <p className="text-clay-muted text-xs leading-relaxed">Малоинвазивное удаление образований</p>
              </div>
            </a>
          </div>
        </div>
