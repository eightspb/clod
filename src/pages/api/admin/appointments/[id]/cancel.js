...
import { createAppointmentCancelEndpoint } from '../../../../../lib/admin-appointment-api.js'
...
function log(stage) {
  console.error('[admin/appointments/[id]/cancel]', stage)
}

export { createAppointmentCancelEndpoint }
export const POST = createAppointmentCancelEndpoint({ workflow, log })
