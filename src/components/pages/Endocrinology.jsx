...
export const ENDOCRINOLOGY_FAQ = [
  ...
  },
  {
    ...
    answer: 'Усталость, набор веса при обычном питании, зябкость, сухость кожи, запоры и подавленное настроение могут указывать на гипотиреоз. Раздражительность, потливость, учащённое сердцебиение и потеря веса — на гипертиреоз. Для уточнения диагноза врач назначит анализ крови на гормоны щитовидной железы.',
  },
  {
      ...
      <section className="relative overflow-hidden pt-6 pb-10">
        ...
        <div className="container-clay relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[0.618fr_0.382fr] gap-10 lg:gap-16 items-start">
            <div>
              <div className="badge-specialty-blue inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold mb-5">
                <Activity size={12} />
                Эндокринология
              </div>
        ...
        <section className="section">
          <div className="container-clay">
            <div className="clay clay-card-soft-blue p-6 md:p-8">
              <h2 className="text-xl heading-serif text-clay-dark mb-2">Узнаёте себя?</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                {symptoms.map((s) => (
                  <div key={s} className="flex items-center gap-2.5 bg-white/60 rounded-xl px-3 py-2.5">
                    <div className="w-2 h-2 rounded-full flex-shrink-0 dot-blue" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {features.map((f, i) => (
                <FadeInSection key={f.title} staggerIndex={i} className="h-full">
                  <div className={`clay ${f.card} card-interactive-blue p-6 flex flex-col`}>
                    ...
                    <div className="badge-specialty-blue inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold self-start">
                      <CheckCircle size={12} />
                      {f.badge}
                    </div>
                  </div>
          ...
          <div className="container-clay">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <h2 className="text-2xl heading-serif text-clay-dark mb-2">Как строится работа</h2>
                {[
                  ...
                  <div key={s.n} className="clay clay-card flex items-start gap-4 p-4 relative">
