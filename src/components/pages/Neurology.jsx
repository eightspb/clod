  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden pt-8 pb-20">
        <div className="blob-lavender absolute -top-12 -right-12 w-72 h-72 opacity-65 pointer-events-none" />
        <div className="blob-mint absolute bottom-0 -left-10 w-56 h-56 opacity-45 pointer-events-none" />
