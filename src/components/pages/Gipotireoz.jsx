...
export function Gipotireoz() {
  return (
    <div>
      <section className="relative overflow-hidden pt-8 pb-12">
        <div className="container-clay relative z-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold mb-5 text-white" style={{ background: 'linear-gradient(145deg, #5B9EC9, #3A7BA8)' }}>
              <Zap size={12} />
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-clay-dark leading-tight mb-5">
              Гипотиреоз:{' '}
              <span className="text-clay-blue">диагностика и лечение в Санкт-Петербурге</span>
            </h1>
            ...
            {[
              ...
              <div key={s.label} className="clay clay-card p-4 text-center">
                <div className="flex items-end justify-center gap-0.5">
                  <span className="text-3xl sm:text-4xl font-extrabold text-clay-blue leading-none">{s.val}</span>
      ...
      <section className="section">
        <div className="container-clay">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Что такое гипотиреоз</h2>
      ...
      <section className="section">
        <div className="container-clay">
          <div className="text-center mb-7">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Диагностика гипотиреоза</h2>
      ...
      <section className="section">
        <div className="container-clay">
          <div className="text-center mb-7">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Лечение гипотиреоза</h2>
      ...
      <section className="section">
        <div className="container-clay">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            <div>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-4">Маршрут пациента</h2>
      ...
      <section className="section">
        <div className="container-clay">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Наши эндокринологи</h2>
        ...
        <div className="container-clay">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {relatedArticles.map((a) => (
              <a key={a.href} href={a.href} className="clay clay-card-soft-blue p-5 flex items-start gap-3 group hover:shadow-lg transition-shadow">
          ...
          <div className="mt-4">
            <a href="/endocrinology" className="clay clay-card p-5 flex items-start gap-3 group hover:shadow-lg transition-shadow">
