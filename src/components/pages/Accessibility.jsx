...
const MEASURES = [
  ...
  },
  {
    ...
    title: 'Кнопка вызова у входа',
    desc: 'Пандуса на лестнице нет. У входа установлена кнопка вызова персонала: нажмите её, и администратор выйдет, поможет подняться и проводит до кабинета без ожидания в очереди. Если вы на коляске, лучше предупредить при записи.',
  },
  {
    icon: Eye,
