...
export function Mastopatiya() {
  return (
    <div>
        ...
        <div className="container-clay relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-clay-dark leading-tight mb-5">
              ...
              <span className="text-clay-mint">наблюдение и лечение в СПб</span>
            </h1>
      ...
      <section className="section">
        <div className="container-clay">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Что такое мастопатия</h2>
      ...
      <section className="section">
        <div className="container-clay">
          <div className="text-center mb-7">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Диагностика мастопатии</h2>
      ...
      <section className="section">
        <div className="container-clay">
          <div className="text-center mb-7">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-clay-dark mb-3">Тактика лечения</h2>
