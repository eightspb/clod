...
const INSERTS = Object.freeze([
  ...
  Object.freeze({ name: 'PatientMergeEvidence', columns: Object.freeze(['id', 'batchId', 'ordinal', 'patientId', 'reason', 'firstSourceName', 'firstSourceRow', 'secondSourceName', 'secondSourceRow', 'createdAt']), key: 'mergeEvidence', scopeColumn: 'batchId', scopeKey: 'batchIds' })
])
