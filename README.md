...
- Боковая панель ограничена высотой окна с отступом под шапкой и прокручивается независимо от статьи колесом, трекпадом или клавиатурой после фокуса. На границах панели прокрутка не передаётся статье; на мобильных панель по-прежнему скрыта. Регрессия проверяется в `e2e/blog.spec.js`.
