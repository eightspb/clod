...
const steps = [
  ...
  },
  {
    ...
    desc: 'Скажем прямо: нужна ли операция, или образование можно удалить через прокол с помощью ВАБ. Ответ в день обращения — без промежуточных звонков и ожидания.',
...
export const SECOND_OPINION_FAQ = [
  ...
  },
  {
    ...
    answer: 'Скажем об этом прямо. Если операция действительно необходима — честно сообщим об этом. Мы не удерживаем пациентов ради выручки и всегда действуем в интересах вашего здоровья.',
  },
  {
