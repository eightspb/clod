export const CLINIC_FACTS = [
  ...
  },
  {
    ...
    desc: 'Запись день в день. Ответ администратора в Max за 2 минуты',
  },
  {
    iconName: 'MapPin',
...
export const WHY_ITEMS = [
  ...
  { iconName: 'Clock',   bg: 'icon-circle-blue',     title: 'Сервис без ожидания',    desc: 'Запись день в день. Ответ администратора в Max за 2 минуты.' },
