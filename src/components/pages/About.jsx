...
const MISSION_COMMITMENTS = [
  {
    ...
    title: 'Забота о здоровье как искусство',
    desc: 'Точная диагностика и профессионализм врачей соединяются с уважением к человеку и спокойной атмосферой в клинике.',
  },
  {
    card: 'clay-card-soft-peach',
    title: 'Женское здоровье целиком',
    desc: 'Молочные железы, репродуктивная и эндокринная системы рассматриваются вместе, а не по отдельности.',
  },
  {
    card: 'clay-card-soft-blue',
    title: 'Сопровождение на каждом шагу',
    desc: 'Помогаем справиться со страхом и неопределённостью: объясняем, что происходит, и остаёмся на связи после приёма.',
  },
]
...
const PRINCIPLES = [
  ...
  },
  {
    ...
    desc: 'После приёма можно уточнить вопросы по телефону или в Max - без ожидания следующего визита.',
  },
  {
    icon: Users,
    iconBg: 'icon-circle-lavender',
          ...
          <div className="container-clay">
            ...
            <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
              <div className="space-y-5 text-clay-muted leading-relaxed">
                ...
                <p>
                  Мы придерживаемся принципа, что молочные железы нельзя рассматривать в отрыве от репродуктивной и эндокринной систем женщины. Поэтому маммологи, гинекологи, эндокринологи, хирурги, онкологи и врачи ультразвуковой диагностики работают в клинике одной командой: случай обсуждается совместно, а пациент получает один согласованный план, а не набор разрозненных назначений.
                </p>
                <p>
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
                {MISSION_COMMITMENTS.map((item) => (
                  <div key={item.title} className={`clay ${item.card} p-5`}>
