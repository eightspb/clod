...
import { createCallRevealEndpoint } from '../../../../../lib/admin-call-api.js'
...
function log(stage) {
  console.error('[admin/calls/[entryId]/reveal]', stage)
}

export { createCallRevealEndpoint }
export const POST = createCallRevealEndpoint({ records, log })
