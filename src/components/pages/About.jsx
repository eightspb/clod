...
const ADVANTAGES = [
  ...
  },
  {
    ...
    desc: 'Топ-манипуляция клиники: удаление образований груди за 30 минут без скальпеля, швов и наркоза. Прокол 2 мм.',
  },
  {
    icon: Users,
    iconBg: 'icon-circle-peach',
    title: 'Эксперты с опытом 15+ лет',
    desc: 'Врачи клиники регулярно повышают квалификацию и работают в мультидисциплинарной команде. Средний стаж специалистов - более 15 лет.',
  },
  {
    icon: Clock,
    iconBg: 'icon-circle-lavender',
    title: 'Понятный план лечения',
    desc: 'На приёме подробно объясняем дальнейшие шаги, а сроки по исследованиям озвучиваем заранее - без неопределённости и лишнего ожидания.',
  },
  {
    icon: Heart,
    iconBg: 'icon-circle-mint',
      ...
      <section className="section">
        <div className="container-clay">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
            {[
              { val: '2014', color: 'text-clay-mint', card: 'clay-card-soft-mint', label: 'год основания клиники', desc: 'Работаем в Санкт-Петербурге более 10 лет' },
      ...
      <section className="section">
        <div className="container-clay">
          ...
          <div className="space-y-5 text-clay-muted leading-relaxed max-w-3xl">
            ...
            <p>
              Основное направление клиники — вакуумная аспирационная биопсия (ВАБ), малоинвазивная процедура в маммологии. Мы помогаем пациентам уточнить диагноз, получить второе мнение и обсудить варианты лечения без спешки, лишних вмешательств и непонятных назначений.
            </p>
          </div>
        </div>
      </section>
