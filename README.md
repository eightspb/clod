...
- Боковая панель ограничена высотой окна с отступом под шапкой. Карточка записи закреплена снизу вне прокручиваемой области: кнопка «Уточнить очный приём» видна целиком, в том числе в статьях с карточкой автора и при высоте окна 600 px. Автор, тема и связанные статьи прокручиваются независимо от статьи колесом, трекпадом или клавиатурой после фокуса. На границах области прокрутка не передаётся статье; на мобильных панель по-прежнему скрыта. Регрессия проверяется в `e2e/blog.spec.js`.
